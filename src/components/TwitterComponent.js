...
const TwitterComponent = () => {
  ...
  const { state: { emergencyData, translations }, resetData, sendTweet } = useContext(AppContext);
  ...
  return <View style={{ height: '20%', backgroundColor: '#325'}}>
    ...
    { textAlign: 'center', color: '#6af', fontWeight: 'bold', fontSize: 25, marginBottom: 20}}>{translations.sendTweetText}</Text>
